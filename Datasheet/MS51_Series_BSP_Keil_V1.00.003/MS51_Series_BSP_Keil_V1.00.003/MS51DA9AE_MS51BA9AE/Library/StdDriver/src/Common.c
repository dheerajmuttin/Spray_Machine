...
void InitialUART0_Timer3(UINT32 u32Baudrate) //use timer3 as Baudrate generator
{
    ...
    clr_T3CON_BRCK;        //UART0 baud rate clock source = Timer3
...
#ifdef FOSC_160000
		RH3    = HIBYTE(65536 - (1000000/u32Baudrate)-1);  		/*16 MHz offset*/
		RL3    = LOBYTE(65536 - (1000000/u32Baudrate)-1);			/*16 MHz offset*/
#endif
#ifdef FOSC_166000
		RH3    = HIBYTE(65536 - (1037500/u32Baudrate));  			/*16.6 MHz */
		RL3    = LOBYTE(65536 - (1037500/u32Baudrate));				/*16.6 MHz */
